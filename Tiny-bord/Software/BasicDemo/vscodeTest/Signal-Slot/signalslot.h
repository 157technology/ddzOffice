#ifndef __SIGNALSLOT_H__
#define __SIGNALSLOT_H__
...
extern std::map<std::pair<std::pair<std::string, MPointer*>, Object*>, std::pair<std::pair<std::string, MPointer*>, Object*>> _map;
